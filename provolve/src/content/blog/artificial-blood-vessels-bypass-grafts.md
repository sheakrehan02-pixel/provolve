...
<figure class="article-figure">
  <img src="/images/bioengineered-vessels/heart-vessel-stent.png" alt="Medical illustration of a human heart connected to a blood vessel cross-section showing red blood cells flowing through an implanted vascular device." />
  <figcaption>Modern vascular medicine combines surgical intervention with engineered devices—but researchers are now pursuing fully living, lab-grown blood vessels.</figcaption>
</figure>
...
<figure class="article-figure">
  <img src="/images/bioengineered-vessels/coronary-bypass-diagram.png" alt="Medical diagram of a human heart showing a blocked coronary artery with plaque buildup and a blue bypass graft connecting the aorta to a vessel below the blockage." />
  <figcaption>Coronary bypass surgery reroutes blood around a blocked artery—but harvesting suitable donor vessels adds risk and recovery time.</figcaption>
</figure>

<figure class="article-figure">
  <img src="/images/bioengineered-vessels/artery-plaque-clot.png" alt="Cross-section illustration of an artery narrowed by yellow atherosclerotic plaque and obstructed by a blood clot." />
  <figcaption>Plaque buildup and clot formation restrict blood flow—the underlying problem that bypass surgery is designed to address.</figcaption>
</figure>

<figure class="article-figure">
  <img src="/images/bioengineered-vessels/bypass-surgical-scar.png" alt="A healthcare worker pointing to a healed vertical sternotomy scar on a patient's chest after open-heart surgery." />
  <figcaption>Traditional bypass surgery leaves a visible sternotomy scar and requires invasive recovery—a burden tissue-engineered grafts could help reduce.</figcaption>
</figure>
...
<figure class="article-figure">
  <img src="/images/bioengineered-vessels/lab-tissue-engineering.png" alt="A researcher in blue gloves pipetting a sample onto a microscope slide in a bright laboratory." />
  <figcaption>Creating living blood vessels requires precise cell culture and bioreactor technology—work that is advancing rapidly in research laboratories worldwide.</figcaption>
</figure>
